...
CREATE TABLE IF NOT EXISTS TiposDeSalas(
idTipoSala INT AUTO_INCREMENT PRIMARY KEY,
nombreTipoSala VARCHAR(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS Salas (
    ...
    FOREIGN KEY (idTipoDeSala) REFERENCES TiposDeSalas(idTipoSala)
);
